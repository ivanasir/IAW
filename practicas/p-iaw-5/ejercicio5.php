<html>
    <body>
        <?php
        /*
        Crear un Script php que use FOR El script debe pintar 10 dirrecciones de email
        con terminaciones diferentes del 0 al 9.
        ...
        */
        ...
        $email="florindo.lopdel0@educa.jcyl.es.";

        for ($i=0; $i < 10; $i++){
            
            echo str_replace("@",$i,"@",$email)
